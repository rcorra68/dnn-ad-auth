<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="Vvf.Auth.Dipvvf.Login" %>
...
<div class="dnnForm dnnLoginService dnnClear" style="margin-top: 15px;">
    ...
    <div class="dnnFormItem">
        ...
        <asp:LinkButton ID="cmdLogin" resourcekey="cmdLogin" CssClass="dnnPrimaryAction" Text="Login" runat="server" ClientIDMode="Static" OnClick="cmdLogin_Click" />
    </div>
</div>
